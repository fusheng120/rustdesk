...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "fusheng12".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rs.fusheng12.cn"];
pub const RS_PUB_KEY: &str = "Mc7HigJySZTXQL6EuxQ60ZrMLsX2o9iA3OZfIYEvVdQ=";
